...
# from autocg.train import MULTI_BLEU_PERL
METEOR_JAR = '/dfsdata2/yangeg1_data/evaluation/meteor-1.5.jar'
METEOR_DATA = '/dfsdata2/yangeg1_data/evaluation/paraphrase-en.gz'
MULTI_BLEU_PERL = '/dfsdata2/yangeg1_data/evaluation/multi-bleu.perl'
STANFORD_CORENLP = '/dfsdata2/yangeg1_data/stanford/stanford-corenlp-full-2018-10-05'
nltk.data.path.append('/dfsdata2/yangeg1_data/nltk_data')
